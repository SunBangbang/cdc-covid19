...
t.brand = {}
t.brand.lg = '流行病学调查信息系统'
t.brand.lgen = 'Epidemiological Investigation Information System'
t.brand.mini = '新冠'
...
t.login.captcha = '验证码'
t.login.demo = '在线演示'
t.login.copyright = '飞趣'

t.home = {}
t.home.sysInfo = {}
t.home.sysInfo.name = '系统名称'
t.home.sysInfo.nameVal = '流行病学调查系统'
...
t.dict.dictLabel = '标题'
t.dict.sort = '排序'
t.dict.dictData = '模板数据'
t.dict.dictDataTemplate = '模板数据, 如: ${性别=gender}，${年龄=age}岁，${国籍=nationality}'
t.dict.remark = '备注'
...
t.role.dataPermissionType = '数据授权类型'

t.user = {}
t.user.username = '用户名'
t.user.subjectDept = '隶属组织'
t.user.deptName = '所在组织'
t.user.email = '邮箱'
t.user.mobile = '手机号'
t.user.idNumber = '身份证'
t.user.specializedSubject = '专业'
t.user.education = '学历'
t.user.positionalTitle = '职称'
t.user.status = '状态'
t.user.status0 = '停用'
t.user.status1 = '正常'
t.user.investigator = '调查员'
t.user.investigator1 = '是'
t.user.investigator0= '否'
t.user.createDate = '创建时间'
t.user.updateDate = '最后修改时间'
t.user.authCode = '授权码'
t.user.password = '密码'
...
t.notice.status='阅读状态'
t.notice.status1='已读'
t.notice.view='查看'
t.notice.receiverName='接受者'
t.notice.readDate='发送时间'
t.notice.readStatus='阅读状态'
t.notice.readStatus0='未读'
t.notice.close='关闭'
t.notice.view1='查看通知'
t.notice.new='新消息'
t.notice.disconnect='断开'
t.notice.disconnectMessage='通知断开'
