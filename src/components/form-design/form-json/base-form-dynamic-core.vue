                  ...
                  >
                    <el-col :span="tableColumn.span">
                      ...
                      >
                        ...
                        >
                          <el-button type="text" @click="uploadClick(item)">
                            {{ item.name }}
                          </el-button>
                        </el-row>
                      </el-form-item>
...
import DynamicFormDialogCore from "@/components/form-design/form-json/dynamic-form-dialog-core";
    ...
    init() {
      ...
      if (this.item.children.type === "form") {
        this.item.children.column.forEach((item) => {
          if (item.collapseTitle && item.coreItem) {
