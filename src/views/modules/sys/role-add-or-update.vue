  ...
  <el-dialog :visible.sync="visible" :title="!dataForm.id ? $t('add') : $t('update')" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form
      ...
      <el-form-item prop="name" :label="$t('role.name')">
        <el-input v-model="dataForm.name" :placeholder="$t('role.name')" maxlength="18" show-word-limit></el-input>
      </el-form-item>
      <el-form-item prop="remark" :label="$t('role.remark')">
        <el-input v-model="dataForm.remark" :placeholder="$t('role.remark')" maxlength="100" show-word-limit></el-input>
      </el-form-item>
      <el-row>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item prop="dataPermissionType" :label="$t('role.dataPermissionType')">
            <ren-select size="mini" v-model="dataForm.dataPermissionType" dict-type="data_permission_type" :placeholder="$t('role.dataPermissionType')"></ren-select>
<!--            <ren-radio-group v-model="dataForm.gender" dict-type="data_permission_type"></ren-radio-group>-->
          </el-form-item>
          <el-form-item v-if="this.isSuperAdmin == 1" prop="shareLevel" label="共享级别">
            <el-select v-model="dataForm.shareLevel" placeholder="请选择">
              <el-option
...
<!--          </el-form-item>-->
    ...
    <template slot="footer">
      <el-button type="primary" :loading="loadingConfirm" @click="dataFormSubmitHandle()" size="mini">{{ $t('confirm') }}</el-button>
